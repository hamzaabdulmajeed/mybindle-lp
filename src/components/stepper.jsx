      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className='flex items-center justify-center gap-2 sm:gap-4 md:gap-8 mb-12 md:mb-16 px-2'>
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
            ...
            <div className="w-8 sm:w-16 md:w-32 lg:w-48 h-[2px] bg-gray-300"></div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6 lg:gap-8">
          {cards.map((card, index) => (
            <div
              key={index}
              className="bg-white shadow-lg rounded-xl p-5 sm:p-6 md:p-8 text-center hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
            >
