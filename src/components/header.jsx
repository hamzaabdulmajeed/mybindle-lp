...
function header() {
    return (
        <div className=' w-full  bg-[#F2F2F2]'>
            <div className='bg-[#FF5349]  lg:h-[700px]'>
            ...
            <div className='max-w-6xl mx-auto px-6 md:px-12'>
                <div className='flex flex-col lg:flex-row lg:items-center pt-8 md:pt-16 gap-8 lg:gap-12'>
                    <div className="flex-1 space-y-6 lg:pr-8 h-[500px] md:h-[600px] lg:h-[650px]">
                    ...
                    <div className="flex-1 relative flex justify-center items-center h-[500px] md:h-[600px] lg:h-[650px]">
                        ...
                        <div className="absolute top-12 md:top-16 left-0 md:left-4 bg-white px-4 py-2 md:px-5 md:py-2.5 rounded-xl shadow-xl transform ">
                            <p className="text-[#FF5349] font-bold text-xs md:text-sm whitespace-nowrap">
                                🔥 Seamless Connections
                            </p>
                        </div>
                        <div className="absolute bottom-24 md:bottom-32 right-0 md:right-4 bg-white px-4 py-2 md:px-5 md:py-2.5 rounded-xl shadow-xl transform ">
                            <p className="text-[#FF5349] font-bold text-xs md:text-sm whitespace-nowrap">
                                🔍 Discover & Explore
                            </p>
                        </div>
