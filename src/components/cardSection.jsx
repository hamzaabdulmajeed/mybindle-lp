function CardSection({ title, desc, cards }) {
  return (
    <div className="w-full bg-[#F2F2F2] py-16 md:pt-40 px-4">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {cards.map((card, index) => (
          <div
            key={index}
            className="bg-[#F2F2F2] shadow-lg rounded-xl p-6 md:p-4 text-center hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
          >
            <h2 className="text-1xl md:text-2xl font-bold mb-4 text-[#1A293C]">
              {card.title}
            </h2>
